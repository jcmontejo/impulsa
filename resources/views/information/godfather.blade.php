			...
			<div class="col-md-8">
				<div class="col-lg-12">
					<div class="page-header">
  						<h1>Apadrina a un pintor</h1>
                        <hr>
				  		<p class="lead">
				  			Es un proyecto encaminado a generar vínculos entre pintores y coleccionistas, fundaciones, empresas, centros de producción. Queremos fomentar el intercambio entre los pintores y estudiantes con aquellas personas interesadas en estimular mediante recursos económicos la producción artística del Taller de Pintura de la Licienciatura en Artes Visuales de la UNICACH.
				  		</p>
    			    </div>
