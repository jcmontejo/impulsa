          ...
          <table class="table table-bordered table-striped table-hover">
            ...
            @foreach($publications as $publication):
                ...
                <tr>
                  ...
                  <td>
                    {!! Form::open(['route' => 'postulate.store', 'method' => 'POST']) !!}
                        {{ Form::hidden('publication', $publication->id) }}
                        {{ Form::hidden('position', $publication->job) }}
                        {{ Form::hidden('company', $publication->company) }}
